...
<table style="font-size:11px;">
    <tr>
        ...
        <td style="width: 5%;">:</td>
        <td style="width: 70%;"><?php echo e($permintaan->latar_belakang); ?></td>
    </tr>
    <tr>
        <td style="width: 25%;">Tujuan</td>
        <td style="width: 5%;">:</td>
        <td style="width: 70%;"><?php echo e($permintaan->tujuan); ?></td>
    </tr>
    <tr>
        <td style="width: 25%;">Target Implementasi Sistem</td>
        <td style="width: 5%;">:</td>
        <td style="width: 70%;"><?php echo e($permintaan->target_implementasi_sistem); ?></td>
    </tr>
    <tr>
        <td style="width: 25%;">Fungsi-fungsi Sistem Informasi</td>
        <td style="width: 5%;">:</td>
        <td style="width: 70%;"><?php echo e($permintaan->fungsi_sistem_informasi); ?></td>
    </tr>
    <tr>
        <td style="width: 25%;">Jenis Aplikasi</td>
        <td style="width: 5%;">:</td>
        <td style="width: 70%;"><?php echo e($permintaan->jenis_aplikasi); ?></td>
    </tr>
    <tr>
        <td style="width: 25%;">Pengguna</td>
        <td style="width: 5%;">:</td>
        <td style="width: 70%;"><?php echo e($permintaan->pengguna); ?></td>
    </tr>
    <tr>
        <td style="width: 25%;">Uraian Permintaan Tambahan/Khusus</td>
        <td style="width: 5%;">:</td>
        <td style="width: 70%;"><?php echo e($permintaan->uraian_permintaan_tambahan); ?></td>
    </tr>
    <tr>
