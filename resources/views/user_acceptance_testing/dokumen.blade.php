...
<h4 class="text-right" style="font-size:11px;"><strong>NO: {{ $useracceptancetesting->first()->nomor_proyek }}</strong></h4>
...
<table style="font-size:11px;">
    ...
    <tr>
        ...
        <td style="width: 5%;">:</td>
        <td style="width: 70%;">{{ $useracceptancetesting->jenis_aplikasi }}</td>
    </tr>
    <tr>
