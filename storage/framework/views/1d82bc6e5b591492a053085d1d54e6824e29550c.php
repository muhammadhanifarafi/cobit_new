...
<h4 class="text-right" style="font-size:11px;"><strong>NO: <?php echo e($qualityassurancetesting->first()->nomor_proyek); ?></strong></h4>
...
<table class="table" style="font-size:11px;">
    ...
    <tr>
        <td class="text-center" colspan="2"><?php echo e($qualityassurancetesting->nama_penyusun); ?><br><?php echo e($qualityassurancetesting->jabatan_penyusun); ?></td>
...
<?php /**PATH C:\laragon\www\ptsi_\resources\views/quality_assurance_testing/dokumen.blade.php ENDPATH**/ ?>